...
const STATS = [
    ...
    { value: "7+", label: "Years Running", icon: Trophy },
    { value: "20+", label: "OSS Contributions", icon: Code2 },
];

const VALUES = [
    { icon: Globe, title: "Open Web", description: "We believe the internet should be open, accessible, and free for everyone — not controlled by a few.", color: "#8a37f5" },
    { icon: Shield, title: "Privacy First", description: "Your data, your rules. We advocate for digital privacy and educate students on staying secure online.", color: "#06b6d4" },
    { icon: Code2, title: "Build in Public", description: "We ship real projects, contribute to open source, and learn by doing — not just by watching.", color: "#f59e0b" },
    { icon: Heart, title: "Community Driven", description: "Every event, workshop, and hackathon is built by students, for students. No hierarchy, just passion.", color: "#ec4899" },
    { icon: BookOpen, title: "Always Learning", description: "From web fundamentals to AI — we host workshops, talks, and bootcamps to keep skills sharp.", color: "#10b981" },
    { icon: Zap, title: "Move Fast", description: "We ship, iterate, and improve. Imperfect action beats perfect inaction every time.", color: "#f97316" },
];

const TIMELINE = [
    { year: "2018", title: "Club Founded", desc: "Mozilla Firefox Club was officially founded at VIT Bhopal with a core team of 10 open-source enthusiasts." },
    { year: "2019", title: "First Hackathon", desc: "Hosted our first university-wide open-source hackathon with over 200 participants and 30+ projects." },
    { year: "2021", title: "Virtual Expansion", desc: "Transitioned online during the pandemic, growing our digital footprint and community reach globally." },
    { year: "2023", title: "Mozilla Recognition", desc: "Officially recognized by Mozilla Foundation as a Campus Club. Community crossed 300+ members." },
    { year: "2025", title: "500 Members", desc: "Hit 500 active members. Launched mentorship program pairing juniors with industry developers." },
];
                ...
                <div className="container mx-auto px-6 max-w-6xl">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
                        ...
                        <p className="text-gray-500 max-w-xl mx-auto text-sm leading-relaxed">
                            Six principles that guide every event, project, and decision we make as a community.
                        </p>
                    </motion.div>
